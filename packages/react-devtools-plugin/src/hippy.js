...
/**
 * this file is copy from https://github.com/facebook/react/tree/v18.0.0/packages/react-devtools-core/src/backend.js
 ...
 */
 ...
 export function connectToDevTools(options: ?ConnectOptions) {
   ...
   ws.onopen = () => {
     console.log('hippy react devtools connected.');
     // start dispatch protocol immediately to support reload hippy page
     startDebug();
   }
   ...
   function handleMessage(event) {
     ...
     // start dispatch protocol when frontend is ready
     if(data.event === 'react-devtools-connect-frontend') {
       bridge.emit('shutdown');
       bridge = null;
       ws.send(JSON.stringify({
         event: 'react-devtools-connect-backend',
       }));
       startDebug();
       return
     }
